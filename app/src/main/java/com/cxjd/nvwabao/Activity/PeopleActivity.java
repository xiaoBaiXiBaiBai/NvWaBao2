...
//        maxAdapter.notifyDataSetChanged();
    ...
    public void MaxData(){
      //  listData(UrlBase);
        People people0 = new People("头部",R.drawable.toubu_img);
        maxList.add(people0);
        People people1 = new People("头",R.drawable.tou_img);
        maxList.add(people1);
        People people2 = new People("眼",R.drawable.yan_img);
        maxList.add(people2);
        People people3 = new People("耳",R.drawable.er_img);
        maxList.add(people3);
        People people4 = new People("鼻",R.drawable.bi_img);
        maxList.add(people4);
        People people5 = new People("口",R.drawable.kou_img);
        maxList.add(people5);
        People people6 = new People("眉",R.drawable.mei_img);
        maxList.add(people6);
        People people7 = new People("牙",R.drawable.ya_img);
        maxList.add(people7);
        People people8 = new People("胸部",R.drawable.xiongbu_img);
        maxList.add(people8);
        People people9 = new People("腹部",R.drawable.fubu_img);
        maxList.add(people9);
        People people10 = new People("四肢",R.drawable.sizhi_img);
        maxList.add(people10);
        People people11 = new People("上肢",R.drawable.shangzhi_img);
        maxList.add(people11);
        People people12 = new People("下肢",R.drawable.xiazhi_img);
        maxList.add(people12);
        People people13 = new People("颈部",R.drawable.jingbu_img);
        maxList.add(people13);
        People people14 = new People("腰部",R.drawable.yaobu_img);
        maxList.add(people14);
        People people15 = new People("背部",R.drawable.biebu_img);
        maxList.add(people15);
        People people16 = new People("臀部",R.drawable.tunbu_img);
        maxList.add(people16);
        People people17 = new People("生殖部位",R.drawable.nanxingshengzhi_img);
        maxList.add(people17);
        People people18 = new People("男性生殖部位",R.drawable.nanxingshengzhi_img);
        maxList.add(people18);
        People people19 = new People("女性生殖部位",R.drawable.nvxingshengzhi_img);
