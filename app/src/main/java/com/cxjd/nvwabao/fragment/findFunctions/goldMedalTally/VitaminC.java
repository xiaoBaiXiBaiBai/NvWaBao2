 ...
 * 营养素金牌榜  --- 维生素C
 */
public class VitaminC extends Fragment {
    //网格布局
    ...
    String[] zhiwu = new String[]{
            "柠檬","猕猴桃","草莓","木耳菜","大枣","西蓝花","雪里蕻","金橘","豆瓣菜","菜花","苦瓜","黑米","荔枝","橘子","橙子","柚子","苤蓝","哈密瓜","构杞","木瓜","蒜薹","龙眼","草菇","香椿"
    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.c_plant);
        gridLayout2 = view.findViewById(R.id.c_animal);
