 ...
 * 营养素金牌榜  --- 维生素D
 */
public class VitaminD extends Fragment {
    //网格布局
    ...
    String[] dongwu = new String[]{
            "猪肉","奶酪","猪血","酸奶","牛奶","羊肉","狗肉","牛肉","兔肉","驴肉","猪蹄","鸽肉","鹌鹑肉","鸡肉","乌鸡肉","野鸡肉","鹿肉"
    };

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vitamin_d,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.d_plant);
        gridLayout2 = view.findViewById(R.id.d_animal);
