 ...
 * 营养素金牌榜  --- 维生素P
 */
public class VitaminP extends Fragment {
    //网格布局
    ...
    String[] zhiwu = new String[]{
            "茄子","枇杷","番茄","橙子","杏","橘子","柚子","大枣","芒果","樱桃","柠檬","荞麦","蓝莓","金橘","西番莲","绿茶","红茶","乌龙茶"
    };

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vitamin_p,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.p_plant);
