 ...
 * 营养素金牌榜  --- 维生素H
 */
public class VitaminHFragment extends Fragment {
    //网格布局
    ...
    String[] zhiwu = new String[]{
            "苤蓝","魔芋","菠菜","洋葱","糯米","玉米","小麦","黑米","小米","大米","燕麦","柿子","桑葚","柚子","橘子","草莓","苹果","香蕉","芦荟","橙子"
    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vitamin_h,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.h_plant);
        gridLayout2 = view.findViewById(R.id.h_animal);
