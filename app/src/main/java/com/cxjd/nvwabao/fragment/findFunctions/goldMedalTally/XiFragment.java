...
public class XiFragment extends Fragment {
    ...
    String[] dongwu = new String[]{
            "海参","鱿鱼","鲈鱼","鲇鱼","鹌鹑蛋","野鸡肉","鳜鱼","海蜇","鳝鱼","河蟹","带鱼","平鱼","鲨鱼","黄鱼","松花蛋","海螺","蛤蜊","淡水虾","海蟹","海水虾"
    };

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_xi,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.xi_plant);
        gridLayout2 = view.findViewById(R.id.xi_animal);
