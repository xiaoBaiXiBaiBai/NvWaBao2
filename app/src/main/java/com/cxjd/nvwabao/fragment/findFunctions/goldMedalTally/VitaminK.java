 ...
 * 营养素金牌榜  --- 维生素K
 */
public class VitaminK extends Fragment {
    //网格布局
    ...
    String[] zhiwu = new String[]{
            "莴笋","小白菜","菠菜","白菜","空心菜","莲藕","蕨菜","豆瓣菜","苘蒿","香椿","苋菜","韭菜","四季豆","海带","紫菜","花生","西蓝花","干辣椒","红茶","绿茶","乌龙茶","色拉油"
    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vitamin_k,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.k_plant);
        gridLayout2 = view.findViewById(R.id.k_animal);
