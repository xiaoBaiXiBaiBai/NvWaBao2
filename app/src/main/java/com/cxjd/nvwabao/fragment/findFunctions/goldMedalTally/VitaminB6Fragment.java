 ...
 * 营养素金牌榜  --- 维生素B6
 */
public class VitaminB6Fragment extends Fragment {
    //网格布局
    ...
    String[] zhiwu = new String[]{
            "黑米","荞麦","雪里蕻","菠菜","香菇","黄豆","腐乳","绿豆","芸豆","红小豆","葵花子","开心果","花生","青辣椒","绿茶","大蒜"
    };

    String[] dongwu = new String[]{
            "猪肝","牛肉","鹌鹑肉","猪肉","鸽肉","乌鸡肉","三文鱼","鲨鱼"
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vitamin_b6,container,false);

        //寻找gridLayout布局
        gridLayout1 = view.findViewById(R.id.b6_plant);
        gridLayout2 = view.findViewById(R.id.b6_animal);
